...
public class AddLog {
    ...
    static  boolean isFileRecycled; // optional
    static  boolean isMailRequired; // optional

    private static AddLog instance = null;
    private AddLog() {
        // Exists only to defeat instantiation.
    }

    public static AddLog getInstance() {
        if(instance == null) {
            instance = new AddLog();
        }
        return instance;
    ...
    public static void init(String path, Context contextRecived, String appVersionR) {
        filePath = path;
    ...
    public static void setDeviceName( String deviceNameR) {
    ...
    public static void setIsMailRequired( boolean dateFormat) {
        isMailRequired = isMailRequired;
    }
    public static void setIsFileRecycled( boolean dateFormat) {
        isFileRecycled = isFileRecycled;
    }
